...
// maximum intensity for a color is 255 value because 1 byte can hold max upto 255
// based on intensity you can give value between 0-255 for your color
// 0 is off 255 full brightness
//
enum Color{
