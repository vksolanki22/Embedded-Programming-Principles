...
extern void ssd1331_clear_screen_as_required(uint16_t hwColor,uint16_t iRowIndex,uint16_t iColumIndex);

extern void ssd1331_init(void);
extern void EnableHorizontalCountinuousScroll(uint16_t iStartRow,uint8_t chSize);
